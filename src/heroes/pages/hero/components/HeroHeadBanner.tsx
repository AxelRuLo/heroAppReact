...
const HeadHeroBanner = ({ superheroData }: Props) => {
  const totalPower =
  ...
  return (
    <div className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white rounded-4xl">
